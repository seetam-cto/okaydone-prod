        ...
        <ScrollContainer>
          ...
          <div className="container">
            <div className="brandpage-section-brand">
              <h1>Empowering the Bengaluru City Police in fighting crimes through <span>recent, relevant & relatable</span> content.</h1>
            </div>
            ...
            <div className="brandpage-section-content">
              ...
              <div className="subtitle">
                <ul>
                  ...
                  whileInView={{x: 0, opacity: 1}}
                  transition={{duration: 0.5, bounce: 0.4, type: 'spring', delay: 0.4}}
                  >Brought humor as an element to bridge the gap between the institution and the general public through memes & pop-culture references.</motion.li>
                  <motion.li
            ...
            <div className="brandpage-section-campaign">
              <div className="title">
                <h2><span style={{"--spancolor": "#FFC64E"}}>Milestones</span><br />1400% followers growth/ week</h2>
              </div>
                  ...
                  <div className="col-3 col-sm-6">
                    ...
                    className="counter-box">
                      ...
                      <div className="couter-box-counter">
                        <CountUp className='counter-box-counter-number' suffix=' WEEKS' end={9} duration={3} startOnMount={false} />
                      </div>
                    </motion.div>
                  </div>
                  <div className="col-3 col-sm-6">
              ...
              <h2>Tweets</h2>
                ...
                >
                  <SwiperSlide className="brandpage-section-campaign-slider-slide">
                    <TwitterTweetEmbed
                      tweetId={'865085841315639297'}
                    />
                  </SwiperSlide>
                  <SwiperSlide className="brandpage-section-campaign-slider-slide">
                    <TwitterTweetEmbed
                      tweetId={'911110637060624385'}
                    />
                  </SwiperSlide>
                  <SwiperSlide className="brandpage-section-campaign-slider-slide">
                    <TwitterTweetEmbed
                      tweetId={'882480553370427392'}
                    />
                  </SwiperSlide>
                  <SwiperSlide className="brandpage-section-campaign-slider-slide">
                    <TwitterTweetEmbed
                      tweetId={'859051129367400450'}
                    />
                  </SwiperSlide>
                  <SwiperSlide className="brandpage-section-campaign-slider-slide">
                    <TwitterTweetEmbed
                      tweetId={'868771374432567296'}
                    />
                  </SwiperSlide>
                </Swiper>
               </div>
