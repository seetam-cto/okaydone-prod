            ...
            <div className="brandpage-section-content">
              ...
              <div className="subtitle">
                <ul>
                  ...
                  >Century&apos;s worst flood hit the region days from the launch</motion.li>
                  <motion.li
                  key={`rcb-subtitle-miles3`}
                  initial={{x: 150, opacity: 0}}
                  whileInView={{x: 0, opacity: 1}}
            ...
            <div className="brandpage-section-content">
              ...
              <div className="subtitle">
                <ul>
                  ...
                  whileInView={{x: 0, opacity: 1}}
                  transition={{duration: 0.5, bounce: 0.4, type: 'spring', delay: 0.2}}
                  >Focused heavily on <span>visual content</span> to garner eyeballs.</motion.li>
                  <motion.li
                  key={`rcb-subtitle-miles2`}
                  initial={{x: 150, opacity: 0}}
                  whileInView={{x: 0, opacity: 1}}
                ...
                <div className="row">
                  ...
                  <div className="col-9 col-sm-12">
                    ...
                    <ul className="brandpage-section-campaign-stats-list">
                      ...
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.0}}
                      ><span>Most followed</span> stand-alone luxury resort on instagram</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.1}}
                      ><span>8 - 12%</span> engagement rate</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.2}}
                      >Created a <span>monopoly</span> in the Coorg region</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.3}}
                      ><span>1250% growth</span> on all digital platforms</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.5}}
                      >Generated <span>3Cr+ revenue</span> during the lockdown, in Future Travel - Vouchers from June to August, 2020</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.4}}
                      ><span>6200+ room nights sold</span> and a revenue of <span>10 crores generated</span> through performance marketing from July to December 2021.</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.6}}
                      >Revenue of <span>10 crores</span> generated through performance marketing from January to December 2021</motion.li>
                      <motion.li
                      initial={{x: 100, opacity: 0}}
                      whileInView={{x: 0, opacity: 1}}
                      transition={{bounce: 0.4, type: 'spring', duration: 0.5, delay: 0.7}}
                      >A constant of <span>90% occupancy</span> throughout the year</motion.li>
                    </ul>
                  </div>
                </div>
              </div>
