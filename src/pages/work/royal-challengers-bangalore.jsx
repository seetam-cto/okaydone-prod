...
export default function RCB() {
  ...
  return (
    <>
      <Head>
        <title>Making RCB #1 | Team Behind World&rsquo;s Most Popular Cricket Team</title>
        ...
        <ScrollContainer>
          ...
          <div className="container">
            <div className="brandpage-section-brand">
              <h1>Enabling an epic <span>fan movement</span> through powerful social media showmanship</h1>
            </div>
            ...
            <div className="brandpage-section-content">
              ...
              <div className="subtitle">
                <ul>
                  ...
                  >The <span>most popular cricket team in the world</span> ranked by interactions on Instagram during 2022: 948M Impressions</motion.li>
                  <motion.li
                  key={`rcb-subtitle-miles2`}
                  initial={{x: 150, opacity: 0}}
                  whileInView={{x: 0, opacity: 1}}
                  transition={{duration: 0.5, bounce: 0.4, type: 'spring', delay: 0.3}}
                  >The 5th <span>most popular sports team in the world</span> ranked by total interactions during 2022</motion.li>
                  <motion.li
                  key={`rcb-subtitle-miles3`}
                  initial={{x: 150, opacity: 0}}
                  whileInView={{x: 0, opacity: 1}}
                  transition={{duration: 0.5, bounce: 0.4, type: 'spring', delay: 0.4}}
                  >Most popular Cricket team <span>in Asia</span></motion.li>
                </ul>
              </div>
            </div>
                  ...
                  <div className="col-3 col-sm-6">
                    ...
                    className="counter-box">
                      ...
                      <div className="couter-box-counter">
                        <CountUp className='counter-box-counter-number' suffix=' DAYS' end={67} duration={3} startOnMount={false} />
                      </div>
                    </motion.div>
                  </div>
                  <div className="col-3 col-sm-6">
                    ...
                    className="counter-box">
                      ...
                      <div className="couter-box-counter">
                        ...
                        prefix='₹'
                        end={0} duration={3} startOnMount={false} />
                      </div>
                    </motion.div>
                  </div>
                  <div className="col-3 col-sm-6">
            ...
            <div className="brandpage-section-campaign">
              <div className="title">
                <h2><span style={{"--spancolor": "#FFC64E"}}>Campaign #2</span><br />New Decade New RCB</h2>
              </div>
              <div className="brandpage-section-campaign-stats">
                <div className="row">
                  <div className="col-3 col-sm-6">
                    ...
                    className="counter-box">
                      ...
                      <div className="couter-box-counter">
                        <CountUp className='counter-box-counter-number' suffix=' DAYS' end={7} duration={3} startOnMount={false} />
                      </div>
                    </motion.div>
                  </div>
                  <div className="col-3 col-sm-6">
